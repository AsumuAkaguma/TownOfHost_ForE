...
namespace TownOfHostForE
{
    ...
    public static class GameSettingMenuPatch
    {
        ...
        public static void StartPostfix(GameSettingMenu __instance)
        {
            ...
            var jumpToAnimalsButton = CreateJumpToCategoryButton(__instance, tohSettingsTab, "TownOfHost_ForE.Resources.TabIcon_AnimalsRoles.png", ref jumpButtonY, AnimalsRoleCategoryHeader);
